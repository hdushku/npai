...
use backend\controllers\UserTypeController; 

/* @var $this yii\web\View */
/* @var $searchModel backend\models\search\UserType */
...
* Grid toolbar config
*/
$createActionButton = Html::a('<i class="glyphicon glyphicon-plus"></i>',['create'],['data-modal-title'=>'Create new UserType','class'=>'create-action-button btn btn-default']);
...
$gridColumns = [
    ...
    [
        ...
        'viewOptions'=>['class'=>'view-action-button','title'=>'View', 'data-toggle'=>'tooltip','data-modal-title'=>'View UserType'],
        'updateOptions'=>['class'=>'update-action-button','title'=>'Update', 'data-toggle'=>'tooltip','data-modal-title'=>'Update UserType'],
